...
export default function PlatformTimeline({ userRole, userGroups }: PlatformTimelineProps) {
  ...
  if (loading) {
    return (
      <div className="bg-white/70 dark:bg-gray-700/70 backdrop-blur-sm rounded-xl shadow-md dark:shadow-lg dark:shadow-purple-900/10 dark:ring-0.5 dark:ring-purple-500/15 border border-white/20 dark:border-gray-600/20 p-4">
