              ...
              rates.map((rate) => (
                <div key={rate.id} className="flex items-center justify-between py-1.5 px-2 bg-gray-50 rounded-md">
                  ...
                  <div className="text-right">
                    <div className="text-xs font-semibold text-gray-800 dark:text-gray-100">{rate.value}</div>
                    <div className="text-xs text-gray-700 dark:text-gray-300">{getScopeLabel(rate.scope)}</div>
                  </div>
                </div>
              ))
            )}
          ...
          {rates.length === 0 ? (
            ...
            rates.map((rate) => (
              <div key={rate.id} className="flex items-center justify-between p-3 bg-white/60 dark:bg-gray-700/60 backdrop-blur-sm rounded-lg border border-gray-200/30 dark:border-gray-600/30 shadow-sm">
                ...
                <div className="text-right">
                  <div className="text-base font-bold text-gray-800 dark:text-gray-100">{rate.value}</div>
