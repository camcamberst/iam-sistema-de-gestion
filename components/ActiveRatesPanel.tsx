...
export default function ActiveRatesPanel({ compact = false, showTitle = true, refreshTrigger }: ActiveRatesPanelProps) {
  ...
  return (
    <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-xl p-6 border border-white/20 dark:border-gray-700/20 shadow-md dark:shadow-lg dark:shadow-blue-900/10 dark:ring-0.5 dark:ring-blue-500/15">
