...
export default function AppleDropdown({
  ...
  return (
    <div className={`relative ${className}`} ref={dropdownRef}>
      ...
      {isOpen && (
        <div className={`absolute z-[99998] w-full mt-1 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg dark:shadow-2xl dark:shadow-cyan-900/20 dark:ring-1 dark:ring-cyan-500/20 ${maxHeight} overflow-auto apple-scroll`}>
          {options.length === 0 ? (
