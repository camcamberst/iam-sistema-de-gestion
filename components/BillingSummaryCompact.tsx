...
export default function BillingSummaryCompact({ userRole, userId, userGroups = [] }: BillingSummaryCompactProps) {
  ...
  return (
    <div className="relative bg-gray-50/80 dark:bg-gray-700/80 backdrop-blur-sm rounded-xl shadow-md border border-white/20 dark:border-gray-700/20 p-4 hover:shadow-xl hover:bg-gray-50/95 dark:hover:bg-gray-600/80 hover:scale-[1.02] transition-all duration-300">
