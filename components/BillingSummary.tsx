...
export default function BillingSummary({ userRole, userId, userGroups = [], selectedDate: propSelectedDate, selectedPeriod: propSelectedPeriod }: BillingSummaryProps) {
  ...
  return (
    <div className="mb-6">
      ...
      <div className="bg-white/80 backdrop-blur-sm rounded-xl p-4 border border-white/20 shadow-lg mb-8">
            ...
            <div className="grid grid-cols-3 gap-4 mb-6 mt-6">
              <div className="bg-blue-50/80 backdrop-blur-sm rounded-lg p-4 hover:shadow-md transition-all duration-300">
                <div className="text-center">
                  ...
                  <div className="inline-block bg-blue-100/80 text-blue-700 px-2 py-1 rounded-full text-xs font-medium">USD Bruto</div>
                </div>
              </div>
              <div className="bg-green-50/80 backdrop-blur-sm rounded-lg p-4 hover:shadow-md transition-all duration-300">
                <div className="text-center">
                  <div className="text-xl font-bold text-green-600 mb-2">${formatCurrency(summary.totalUsdModelo)}</div>
                  <div className="inline-block bg-green-100/80 text-green-700 px-2 py-1 rounded-full text-xs font-medium">USD Modelo</div>
                </div>
              </div>
              <div className="bg-purple-50/80 backdrop-blur-sm rounded-lg p-4 hover:shadow-md transition-all duration-300">
                <div className="text-center">
                  <div className="text-xl font-bold text-purple-600 mb-2">${formatCurrency(summary.totalUsdSede)}</div>
                  <div className="inline-block bg-purple-100/80 text-purple-700 px-2 py-1 rounded-full text-xs font-medium">USD Sede</div>
                </div>
              </div>
            </div>
          )}
