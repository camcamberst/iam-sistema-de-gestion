...
export default function ChatWidget({ userId, userRole }: ChatWidgetProps) {
  ...
  // 🔧 NUEVO: Estado para visibilidad del botón durante scroll
  ...
  // 🔧 NUEVO: Mantener botón visible durante scroll (sin cambiar posición)
  useEffect(() => {
  ...
  return (
    <>
      {/* Botón flotante para abrir el chat - POSICIÓN ORIGINAL */}
      <button
        onClick={toggleChat}
        onContextMenu={(e) => {
          e.preventDefault();
