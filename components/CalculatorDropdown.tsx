...
export default function CalculatorDropdown({ isActive, isOpen, onToggle }: CalculatorDropdownProps) {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {/* Dropdown Menu */}
      {isOpen && (
        <div className="absolute top-full left-0 mt-2 w-80 bg-white/95 dark:bg-gray-800/95 backdrop-blur-md border border-white/30 dark:border-gray-700/30 rounded-xl shadow-xl dark:shadow-lg dark:shadow-blue-900/15 dark:ring-0.5 dark:ring-blue-400/20 z-[9998] animate-in slide-in-from-top-2 duration-200">
          <div className="p-3">
            <div className="mb-2">
