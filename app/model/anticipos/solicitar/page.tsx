              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    placeholder=""
                    className={`apple-input w-full pr-20 pl-14 ${montoError && anticipoData.monto_solicitado > 0 ? 'border-red-500 focus:ring-red-500' : ''}`}
                  />
                  <div className="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-500 font-medium select-none">
                    $
                  </div>
