      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6 pt-16">
        ...
        <div className="mb-16">
          <div className="relative">
            ...
            <div className="relative bg-white/80 backdrop-blur-sm rounded-xl p-6 border border-white/20 shadow-lg dark:bg-gray-800/80 dark:border-gray-700/20 dark:shadow-gray-900/20">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h1 className="text-2xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent dark:from-white dark:to-gray-200">
                      Mi Calculadora
                    </h1>
        ...
        <div className="relative bg-white/70 backdrop-blur-sm rounded-xl shadow-md border border-white/20 p-6 mb-6 hover:shadow-lg transition-all duration-300 dark:bg-gray-800/70 dark:border-gray-700/20 dark:shadow-gray-900/20">
          <div className="flex items-center space-x-2 mb-4">
            ...
            <h2 className="text-base font-semibold text-gray-900 dark:text-white">Tasas Actualizadas</h2>
          </div>
          <InfoCardGrid
            cards={[
              {
        ...
        {/* Error Message */}
        {error && (
          <div className="relative bg-white/70 backdrop-blur-sm rounded-xl shadow-md border border-white/20 p-6 mb-6 dark:bg-gray-800/70 dark:border-gray-700/20 dark:shadow-gray-900/20">
            <div className="text-center py-8">
              ...
              <h4 className="text-base font-semibold text-gray-900 dark:text-white mb-2">Error al cargar calculadora</h4>
        ...
        <div className="relative bg-white/70 backdrop-blur-sm rounded-xl shadow-md border border-white/20 p-6 mb-6 dark:bg-gray-800/70 dark:border-gray-700/20 dark:shadow-gray-900/20">
          <div className="flex items-center space-x-2 mb-4">
            ...
            <h2 className="text-base font-semibold text-gray-900 dark:text-white">Calculadora de Ingresos</h2>
          </div>
          ...
          {(() => {
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead>
                  <tr className="border-b border-gray-200/50 bg-gray-50/50 backdrop-blur-sm dark:border-gray-600/50 dark:bg-gray-800/50">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-all duration-300 dark:bg-gray-800 dark:border-gray-700 dark:shadow-gray-900/20">
