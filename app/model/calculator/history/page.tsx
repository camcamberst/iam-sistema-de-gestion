      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex items-center justify-center pt-16">
        <div className="relative bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-xl shadow-lg border border-white/20 dark:border-gray-700/20 p-8 max-w-md">
          <div className="text-center">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300">Solo las modelos pueden acceder a esta página.</p>
          </div>
        </div>
      </div>
    );
            ...
            {filteredPeriods.map((period, index) => {
              ...
              return (
                <div key={periodKey} className="bg-white dark:bg-gray-700/80 rounded-xl shadow-sm border border-gray-100 dark:border-gray-600/20 p-6 dark:shadow-lg dark:shadow-blue-900/10 dark:ring-0.5 dark:ring-blue-500/15">
                  ...
                  {isExpanded && (
                    <div className="mt-4">
                      <h4 className="text-sm font-medium text-gray-700 dark:text-gray-200 mb-3">Detalles por plataforma:</h4>
                      <InfoCardGrid 
                      ...
                      <div className="bg-gray-50 dark:bg-gray-600/80 rounded-lg p-4">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                          ...
                          <div>
                            <span className="font-medium text-gray-700 dark:text-gray-200">Última actualización:</span>
                            <span className="ml-2 text-gray-600 dark:text-gray-300">
