    ...
    <div className="aim-page-bg">
      <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pt-16">
        ...
        <PageHeader
          ...
          subtitle="Revisa el estado de tus solicitudes de anticipo"
          glow="model"
          icon={
          ...
          actions={
            <button
              ...
              className="w-full md:w-auto btn-aim-primary text-sm sm:text-base"
            >
              Nueva Solicitud
            </button>
          }
        ...
        <GlassCard padding="none" className="rounded-xl p-3 sm:p-4 mb-4 sm:mb-6">
