...
export default function ConfigCalculatorPage() {
  ...
  // 🔧 FIX: Variable local para plataformas (solución definitiva)
  ...
  const loadData = async () => {
    try {
      ...
      platformsLocal = platformsData.config?.platforms || [];
