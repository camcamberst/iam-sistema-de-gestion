          ...
          <div className="space-y-6">
            ...
            <div className="relative theme-card backdrop-blur-sm rounded-xl theme-shadow theme-border p-6">
              <div className="flex items-center space-x-2 mb-4">
                ...
                <h2 className="text-base font-semibold theme-text-primary">Mi perfil</h2>
              </div>
              <p className="text-xs theme-text-secondary mb-4">Revisa tu información</p>
              <div className="space-y-2">
                <div className="text-sm theme-text-primary">Email: {user.email}</div>
                <div className="text-sm theme-text-primary">Grupo: {user.groups[0] || '—'}</div>
              </div>
            </div>
            ...
            <div className="relative theme-card backdrop-blur-sm rounded-xl theme-shadow theme-border p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-4">
                <div className="p-3 rounded-lg bg-blue-50 dark:bg-blue-900/20 text-center">
                  <div className="text-xs theme-text-secondary">USD Bruto (hoy)</div>
              ...
              <div className="mt-4">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-xs theme-text-secondary">${summary ? summary.usdBruto.toFixed(0) : '—'} / ${summary ? summary.goalUsd.toFixed(0) : '—'} USD</span>
                </div>
                ...
                <div className="text-right text-xs theme-text-secondary mt-1">{summary ? Math.min(100, summary.pct).toFixed(0) : 0}%</div>
              </div>
