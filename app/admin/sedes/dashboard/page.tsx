            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex-1 max-w-xs relative">
                <div className="relative dropdown-container">
                  ...
                  {dropdownOpen === 'sede' && (
                    <div className="absolute top-full left-0 right-0 mt-2 bg-white/95 dark:bg-gray-800/95 backdrop-blur-sm rounded-xl shadow-lg border border-white/20 dark:border-gray-700/20 z-50 max-h-60 overflow-y-auto">
                      <div className="py-2">
                        <button
                          onClick={() => {
                            setSelectedSede('');
