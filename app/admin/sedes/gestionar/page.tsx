      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pt-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
          ...
          <div className="flex flex-col space-y-6 h-full">
            ...
            {/* Crear Nuevo Afiliado - Solo para Super Admin */}
            {userRole === 'super_admin' && (
              <div className="relative flex-1">
                <div className="absolute inset-0 bg-gradient-to-br from-purple-500/5 to-pink-500/5 rounded-2xl blur-sm"></div>
                <div className="relative bg-white/70 dark:bg-gray-700/70 backdrop-blur-sm rounded-xl shadow-md border border-white/20 dark:border-gray-600/20 p-6 h-full flex flex-col dark:shadow-lg dark:shadow-purple-900/10 dark:ring-0.5 dark:ring-purple-500/15">
                  <div className="flex items-center justify-between h-full">
                    <div className="flex items-center space-x-2">
        ...
        */}
        ...
        {/* Modal Crear Afiliado - Solo para Super Admin */}
        {showCreateAffiliate && userRole === 'super_admin' && (
          <StandardModal
