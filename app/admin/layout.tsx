          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="relative" ref={userPanelRef}>
                ...
                {showUserPanel && (
                  <div className="absolute right-0 mt-3 w-80 bg-white/90 backdrop-blur-md border border-gray-200/50 rounded-xl shadow-lg p-6 z-50 animate-in slide-in-from-top-2 duration-200">
                    {loadingUser ? (
                      ...
                      <div className="space-y-5">
                        ...
                        <div className="flex items-center space-x-4">
                          <div className="w-14 h-14 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 text-white flex items-center justify-center shadow-md">
                            <span className="text-xl font-semibold">{userInfo.name.charAt(0).toUpperCase()}</span>
                          </div>
                        ...
                        <div className="space-y-3">
                          <div className="flex items-center text-sm">
                            <span className="text-gray-500 font-medium w-12">Rol</span>
                            <span className="text-gray-900 font-semibold capitalize ml-4">
                              {String(userInfo.role).replace('_',' ')}
                            </span>
                          </div>
                          <div className="flex items-center text-sm">
                            <span className="text-gray-500 font-medium w-12">ID</span>
                            <span className="text-gray-700 font-mono text-xs ml-4">
                              {userInfo.id}
                            </span>
                          </div>
                          {userInfo.role !== 'super_admin' && userInfo.groups?.length > 0 && (
                            <div className="flex items-start text-sm">
                              <span className="text-gray-500 font-medium w-12 mt-0.5">Grupos</span>
                        ...
                        <div className="pt-4 border-t border-gray-200">
                          <button
                            ...
                            className="w-full px-4 py-3 text-sm rounded-lg bg-gray-50 hover:bg-gray-100 border border-gray-200 text-gray-700 hover:text-gray-900 transition-all duration-200 font-medium flex items-center justify-center space-x-2"
                          >
                      ...
                      <div className="text-center py-8">
                        ...
                        <div className="text-sm text-gray-600">No autenticado</div>
                      </div>
                    )}
                  </div>
                )}
