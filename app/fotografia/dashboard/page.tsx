    ...
    const load = async () => {
      try {
        ...
        const current = {
          ...
          role: (userRow?.role as Role) || 'fotografia',
          groups,
        };
        setUser(current);
      } finally {
      ...
      <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pt-16">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h1 className="text-2xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 dark:from-gray-100 dark:to-gray-300 bg-clip-text text-transparent">
                    Dashboard Fotografía
                  </h1>
                  {user && (
                    <p className="mt-1 text-sm text-gray-600 dark:text-gray-300">
                      Bienvenido, {user.name} · Rol: Fotografía
        ...
        <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-xl shadow-md border border-white/20 dark:border-gray-700/20 p-6">
          <p className="text-gray-600 dark:text-gray-300">
            Panel de Fotografía - Las funcionalidades específicas se agregarán próximamente.
          </p>
        </div>
      </div>
    </div>
