        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center">
              <Link href="/fotografia/dashboard" className="flex items-center space-x-3 group">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-xs text-gray-600 dark:text-gray-300 font-medium tracking-wide">Panel Fotografía</span>
                </div>
              </Link>
            </div>
