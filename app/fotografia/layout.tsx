        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center flex-1 min-w-0">
              <Link href="/fotografia/dashboard" className="flex items-center space-x-2 sm:space-x-3 group">
                ...
                <div className="flex flex-col min-w-0">
                  ...
                  <span className="hidden sm:block text-xs text-gray-600 dark:text-gray-300 font-medium tracking-wide">Panel Fotografía</span>
                </div>
              </Link>
            </div>
