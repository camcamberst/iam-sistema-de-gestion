// Script para crear las tablas de chat en producción
// Este script se ejecutará directamente en el navegador

const createChatTablesSQL = `
...
console.log('📋 SQL para crear tablas de chat:');
