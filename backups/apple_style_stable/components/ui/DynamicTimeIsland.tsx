        ...
        {currentMessage && (
          ...
          >
            ...
            <p className={`text-[11px] sm:text-[12px] font-bold tracking-wide whitespace-nowrap ${
              currentMessage.closed
                ? 'text-purple-600 dark:text-[#c488fc] drop-shadow-none dark:drop-shadow-[0_0_8px_rgba(196,136,252,0.4)]'
                : currentMessage.urgent 
                ? 'text-teal-600 dark:text-[#2dd4bf] drop-shadow-none dark:drop-shadow-[0_0_8px_rgba(45,212,191,0.4)]' 
                : 'text-emerald-600 dark:text-[#34d399] drop-shadow-none dark:drop-shadow-[0_0_8px_rgba(52,211,153,0.4)]'
            }`}>
              {currentMessage.text}
            </p>
          </div>
  ...
  return (
    <div className={`w-full max-w-full mx-auto mb-6 px-2 sm:px-0 ${className}`}>
      <div className="relative mx-0 w-full">
        <div className="relative overflow-hidden bg-white/40 dark:bg-[#0a0a0ade] backdrop-blur-xl rounded-full border border-white/20 dark:border-white/[0.05] shadow-sm dark:shadow-none py-1.5 h-11 mobile-marquee-viewport px-0 sm:px-6">
