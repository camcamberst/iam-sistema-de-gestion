...
export default function StandardModal({
  ...
  const modalContent = (
    <div
      ...
      aria-modal="true"
      role="dialog"
      className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-[99999] px-0 py-4 sm:p-4"
      style={{ 
        position: 'fixed',
        top: 0,
        left: 0,
    ...
    >
      <div
        className={`${paddingClass} w-full ${maxWidthClass} max-h-[calc(100vh-2rem)] overflow-y-auto bg-white dark:bg-gray-800 border-y sm:border border-gray-200 dark:border-gray-600 rounded-2xl shadow-xl ${className}`}
