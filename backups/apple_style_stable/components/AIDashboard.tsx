...
export default function AIDashboard({ userId, userRole }: AIDashboardProps) {
  ...
  return (
    <div className="relative bg-white/70 dark:bg-gray-900/60 backdrop-blur-2xl rounded-xl sm:rounded-2xl md:rounded-3xl shadow-xl shadow-indigo-900/5 dark:shadow-black/20 border border-white/50 dark:border-white/10 transition-all duration-300 hover:bg-white/80 dark:hover:bg-gray-800/60">
      {/* Header */}
      <div 
      ...
      >
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <div>
              <h3 className="text-base font-semibold text-gray-900 dark:text-white drop-shadow-sm dark:drop-shadow-[0_0_8px_rgba(255,255,255,0.4)]">Asistente AI</h3>
