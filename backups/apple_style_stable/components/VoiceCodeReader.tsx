...
export default function VoiceCodeReader({ className = '' }: VoiceCodeReaderProps) {
  ...
  return (
    <div className={`flex flex-col gap-1.5 sm:gap-2 h-full ${className}`}>
      ...
      <div className="flex-1 glass-card bg-white/40 dark:bg-black/30 max-sm:dark:bg-black/60 backdrop-blur-3xl rounded-[1.25rem] sm:rounded-2xl border border-white/20 dark:border-white/5 max-sm:dark:border-white/10 shadow-sm dark:shadow-none p-3 sm:p-4 flex flex-col">
