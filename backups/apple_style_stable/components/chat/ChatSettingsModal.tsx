...
const THEMES = [
  ...
  },
  {
    id: 'boreal',
    name: 'Aurora Boreal',
    description: 'La identidad visual de la plataforma. Gradientes cyan a fucsia y fondos interestelares.',
    previewColors: ['bg-slate-50 dark:bg-[#0a0f1a] border-fuchsia-500/30', 'bg-gradient-to-r from-cyan-400 to-fuchsia-500'],
  },
  {
    id: 'obsidian',
    name: 'Obsidian Apple',
      ...
      >
        ...
        <div className="relative z-10">
          <div className="flex justify-between items-start mb-6">
            <div>
              <h2 className="text-xl font-bold text-gray-900 dark:text-white tracking-tight drop-shadow-sm mb-1">Selecciona un tema</h2>
              <p className="text-sm text-gray-600 dark:text-gray-400 font-medium">
                Personaliza la apariencia de tus chats.
              </p>
            </div>
            <button onClick={onClose} className="p-2 text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white bg-gray-100 hover:bg-gray-200 dark:bg-white/5 dark:hover:bg-white/10 rounded-full transition-colors ml-4 shrink-0">
          ...
          <div className="flex flex-col-reverse sm:flex-row justify-end gap-3 sm:gap-4 mt-2">
            <button
              onClick={onClose}
              className="w-full sm:w-auto px-6 py-3 sm:py-2.5 text-[14px] font-bold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white bg-transparent hover:bg-gray-100 dark:hover:bg-white/5 rounded-full transition-colors"
            >
              Cancelar
            </button>
            <button
