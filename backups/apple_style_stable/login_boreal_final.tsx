    ...
    <div className="relative min-h-screen overflow-hidden flex font-sans selection:bg-indigo-500/30">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden bg-[#f8fafc]">
        ...
        <div className="absolute top-1/2 left-1/2 w-0 h-0">
          ...
          >
            {/* LIGHT HEMISPHERE BLOBS (AIM Primary Colors: Blue & Indigo) */}
            <div className="absolute top-[30%] left-[25%] w-[45vmax] h-[45vmax] bg-indigo-300/40 rounded-full blur-[160px]"></div>
            <div className="absolute bottom-[30%] left-[25%] w-[40vmax] h-[40vmax] bg-blue-300/40 rounded-full blur-[160px]"></div>
            
            {/* DARK HEMISPHERE BLOBS (AIM Night Colors: Deep Blue & Deep Indigo) */}
            <div className="absolute top-[30%] right-[30%] w-[50vmax] h-[50vmax] bg-slate-300/50 rounded-full blur-[160px] animate-pulse" style={{ animationDuration: '8s' }}></div>
            <div className="absolute bottom-[30%] right-[25%] w-[45vmax] h-[45vmax] bg-indigo-200/50 rounded-full blur-[160px]"></div>
          </div>
        </div>
      ...
      <div className="relative z-10 w-full flex min-h-screen items-center justify-center p-4">
        ...
        <div className="w-full max-w-md relative">
          ...
          <div className="w-full max-w-md bg-[#0a0a0ade] backdrop-blur-3xl border border-white/10 rounded-[2.5rem] shadow-[0_12px_40px_rgba(0,0,0,0.6)] p-8 sm:p-10 relative overflow-hidden group z-10">
            ...
            <div className="flex flex-col items-center justify-center mb-10 relative z-10 w-full">
              ...
              <div className="flex items-center justify-center w-full mb-6">
                <div className="flex items-center group cursor-default">
                  ...
                  <div className="flex-none w-[4.5rem] h-[4.5rem] bg-gradient-to-br from-[#ffffff] to-[#e2e8f0] rounded-[1.2rem] border border-white/20 flex items-center justify-center shadow-[0_0_20px_rgba(255,255,255,0.4)] z-10 box-border anim-pop group-hover:scale-105 transition-transform duration-300">
                    <span className="text-[#0a0f1a] font-extrabold tracking-wider text-[1.25rem]">AIM</span>
                  </div>
                  ...
                  <div className="flex items-center transition-all duration-700 overflow-visible opacity-100 translate-x-0" style={{ clipPath: "inset(-100% -100% -100% 0%)" }}>
                    ...
                    <div className="w-[5px] h-[48px] bg-white rounded-full shadow-[0_0_12px_rgba(255,255,255,0.7)] ml-4 mr-4 anim-bar"></div>
                    
                    {/* Target Name (Slides from the divider) */}
                    <div className="relative inline-flex items-center pb-1 pr-6 anim-slide-text">
                      <span className="absolute flex items-center text-5xl sm:text-[3.5rem] leading-none font-extrabold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-sky-400 via-indigo-500 to-fuchsia-400 blur-[10px] opacity-90 select-none pointer-events-none anim-aurora-glow" aria-hidden="true">
                        Auror
                        <span className="relative inline-block">
                          a
                          <svg className="absolute top-[2px] sm:top-[3px] -right-[13px] sm:-right-[15px] w-[20px] h-[20px] sm:w-[24px] sm:h-[24px] text-fuchsia-400 animate-lucero" viewBox="0 0 24 24" fill="currentColor">
                            <path d="M12 0C12 6.627 17.373 12 24 12C17.373 12 12 17.373 12 24C12 17.373 6.627 12 0 12C6.627 12 12 6.627 12 0Z" />
                          </svg>
                        </span>
                      </span>
                      <span className="relative flex items-center text-5xl sm:text-[3.5rem] leading-none font-extrabold tracking-tight text-white whitespace-nowrap drop-shadow-[0_0_12px_rgba(255,255,255,0.5)]">
                        Auror
                        <span className="relative inline-block">
                          a
                          <svg className="absolute top-[2px] sm:top-[3px] -right-[13px] sm:-right-[15px] w-[20px] h-[20px] sm:w-[24px] sm:h-[24px] animate-lucero" viewBox="0 0 24 24" fill="url(#login-aurora-gradient-star)">
                            <defs>
