    ...
    const baseItems = [
      {
        ...
        subItems: userRole === 'modelo' ? [ { label: 'Calculadora', href: '/model/calculator' } ] : []
      }
    ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      ...
      <header className="bg-white dark:bg-gray-900 backdrop-blur-md border border-white/20 dark:border-gray-700/30 sticky top-0 z-[99999] shadow-lg dark:shadow-lg dark:shadow-purple-900/15 dark:ring-0.5 dark:ring-purple-400/20">
        <div className="max-w-7xl mx-auto px-7 sm:px-10 md:px-12 lg:px-16">
          <div className="flex items-center justify-between h-14 md:h-16">
            {/* Logo */}
            <div className="flex items-center space-x-2 z-50 bg-transparent">
              <Link href="/superadmin/dashboard" className="flex items-center space-x-1 group transition-all duration-500">
                ...
                <div className="hidden sm:flex items-center space-x-0.5 transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)]">
                  <span className="text-[#0a0f1a] dark:text-white font-medium text-lg md:text-2xl opacity-60 pb-0.5">|</span>
                  <div className="relative inline-flex items-center">
                    <span className="absolute text-base sm:text-lg md:text-[22px] font-black tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-sky-400 via-indigo-500 to-fuchsia-500 blur-[6px] opacity-70 dark:opacity-90 select-none pointer-events-none" aria-hidden="true">Aurora</span>
                    <span className="relative text-base sm:text-lg md:text-[22px] font-black text-[#0a0f1a] dark:text-white tracking-tight whitespace-nowrap">Aurora</span>
                  </div>
                </div>
              </Link>
            </div>
