                ...
                {selectedPeriod && windowInfo?.isWithin && (
                  <>
                    <div>
                      ...
                      <div className="flex bg-gray-100/50 dark:bg-[#1a1f2e]/50 p-1 rounded-xl border border-gray-200/50 dark:border-gray-700/50">
                        <button
                          type="button"
                          onClick={() => {
                          ...
                          className={`flex-1 px-4 py-2.5 rounded-lg text-sm font-medium transition-all duration-200 ${
                            tipoSolicitud === 'monto'
                              ...
                              : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 hover:bg-gray-50/50 dark:hover:bg-gray-800/20 transparent'
                          }`}
                        >
                          Monto en COP
                        </button>
                    ...
                    <button
                      ...
                      className="w-full flex items-center justify-center gap-2 px-6 py-3.5 sm:py-4 text-sm sm:text-base font-bold rounded-xl bg-gradient-to-r from-blue-500 via-indigo-500 to-violet-500 text-white shadow-[0_0_20px_rgba(99,102,241,0.4),0_4px_12px_rgba(99,102,241,0.3)] hover:shadow-[0_0_25px_rgba(99,102,241,0.5),0_6px_16px_rgba(99,102,241,0.35)] active:scale-[0.98] transition-all duration-300 ease-out touch-manipulation disabled:opacity-50 disabled:cursor-not-allowed"
                    >
