...
export default function SolicitarAnticipoPage() {
      ...
      <div className="min-h-screen relative w-full overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-10 max-w-md mx-auto text-center p-6 bg-white/10 dark:bg-gray-900/40 backdrop-blur-md rounded-2xl border border-white/20 shadow-xl">
          <div className="mb-4">
            ...
            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2 drop-shadow-sm dark:drop-shadow-[0_0_8px_rgba(255,255,255,0.4)]">
  ...
  return (
    <div className="min-h-screen relative w-full overflow-hidden">
      <ModelAuroraBackground />
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-20 xl:px-32 py-8 pt-16">
      <style jsx>{`
      ...
      `}</style>
        ...
        <GlassCard glow="model" padding="none" className="rounded-2xl p-3 sm:p-6 mb-4 sm:mb-6 hover:shadow-md transition-all duration-300">
          ...
          {/* 3 columnas en todo dispositivo con caja de contraste móvil (Apple Style 2) */}
            ...
            <div className="flex justify-center pt-6 sm:pt-8 mt-4 border-t border-gray-200 dark:border-gray-800">
              <div className="inline-flex p-1 bg-gray-200/50 dark:bg-gray-800/80 backdrop-blur-md rounded-full shadow-inner border border-white/20 dark:border-white/5 w-full sm:w-auto">
                <button
                  type="button"
                  onClick={() => router.back()}
                  className="w-full sm:w-auto px-6 py-2.5 text-sm font-semibold text-gray-600 dark:text-gray-400 rounded-full hover:bg-white dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-gray-200 hover:shadow-sm transition-all"
                >
                  Cancelar
                </button>
                <button
                  ...
                  className="w-full sm:w-auto px-8 py-2.5 text-sm font-semibold rounded-full bg-white dark:bg-gray-700 text-gray-900 dark:text-white shadow-sm disabled:opacity-50 transition-all ml-1"
                >
