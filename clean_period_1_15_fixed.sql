-- =====================================================
-- 🔄 LIMPIEZA COMPLETA DEL PERÍODO 1-15 OCTUBRE (CORREGIDO)
-- =====================================================
-- Script SQL para limpiar TODAS las calculadoras del período 1-15 octubre
-- Usa period_type válido según las restricciones de la tabla
-- =====================================================
...
-- Usar 'periodo_1' en lugar de 'quincena_1' para evitar restricción
...
-- 2. Los valores estarán archivados en calculator_history con period_type = 'periodo_1'
