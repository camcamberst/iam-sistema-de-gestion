-- =====================================================
-- 🔄 LIMPIAR DATOS INCORRECTOS DEL HISTORIAL
-- =====================================================
...
-- 1. Eliminar datos del período 2 (16-31) que no deberían existir
-- (porque es el período en curso)
DELETE FROM calculator_history 
WHERE period_type = '16-31';

-- 2. Verificar si hay datos duplicados en el período 1
...
-- 4. Verificar que no quedan datos del período 2
SELECT 
...
-- 5. Mostrar resumen final por modelo
SELECT 
