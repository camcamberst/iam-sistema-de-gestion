-- =====================================================
-- 🏠 ARQUITECTURA MODERNA: SMART HOME DATABASE
-- =====================================================
...
CREATE TABLE user_profiles (
  ...
  name TEXT NOT NULL,
  role TEXT NOT NULL CHECK (role IN ('super_admin', 'admin', 'modelo', 'chatter')),
...
CREATE TABLE sales (
  ...
  chatter_id UUID REFERENCES chatter_profiles(id) ON DELETE SET NULL,
...
ALTER TABLE chatter_profiles ENABLE ROW LEVEL SECURITY;
...
-- Perfiles de usuario: Solo pueden ver su propio perfil y perfiles de su organización
...
-- Trigger para sincronizar auth.users con user_profiles
CREATE OR REPLACE FUNCTION handle_new_user()
RETURNS TRIGGER AS $$
BEGIN
  INSERT INTO user_profiles (id, organization_id, name, role)
  VALUES (
    NEW.id,
