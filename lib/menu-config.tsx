  ...
  },
  {
    ...
    subItems: [
      ...
      { 
        ...
        description: 'Estadísticas y reportes del sistema de ahorros'
      }
    ]
  },
  {
    ...
    subItems: [
      {
        ...
        description: 'Categorías de productos (solo super admin)'
      },
      {
        label: 'Productos',
        ...
        description: 'Catálogo de productos y referencias'
      },
      {
        label: 'Inventario',
        ...
        description: 'Stock por sede y traslados'
      },
      {
        label: 'Pedidos',
        ...
        description: 'Gestión de pedidos y financiaciones'
      },
      {
        label: 'Promociones',
      ...
      },
      {
        ...
        description: 'Gestión de categorías (solo super admin)'
      }
    ]
  },
  {
...
const gestorMenu: MenuItem[] = [
  ...
  },
  {
    ...
    subItems: [
      { 
        label: 'Stats', 
        href: '/gestor/gestion-agencia/stats',
        icon: (
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
          </svg>
        ),
        description: 'Registrar ingresos exactos de modelos por período'
      },
      { 
        label: 'Rates Históricas', 
        ...
        description: 'Configurar rates históricas para recalcular períodos pasados'
      }
    ]
  }
];
