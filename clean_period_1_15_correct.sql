...
-- Usa '1-15' para period_type (valor válido según restricción)
-- =====================================================
...
-- Usar '1-15' para period_type (valor válido según restricción)
...
-- 2. Los valores estarán archivados en calculator_history con period_type = '1-15'
